<div class="section section-insert">
    ...
    <form class="form-insert" enctype="multipart/form-data" method="post" action="<?php echo base_url("admin/tour_package_insert"); ?>">
        ...
        <div class="form-item">
            ...
            <input type="text" name="tour_group_description" class="form-input input-description" maxlength="225" />
        </div>
        <div class="tanggal-container">
            <input type="hidden" name="tanggal_count" value="1" />
            <div class="tanggal-inner-container">
                <div class="form-item-inline">
                    <div class="form-label-inline">Mulai Tanggal</div>
                    <input type="text" name="date_start_1" class="form-input input-date-start" maxlength="10" data-type="date" />
                </div>
                <div class="form-item-inline">
                    <div class="form-label-inline">Sampai Tanggal</div>
                    <input type="text" name="date_end_1" class="form-input input-date-end" maxlength="10" data-type="date" />
                </div>
            </div>
        </div>
        <div class="btn btn-add-tanggal">Add Tanggal</div>
        <div class="form-item">
            <div class="form-label-inline">Rute</div>
            <input type="text" name="rute" class="form-input input-rute" maxlength="250" />
        </div>
        <div class="form-item">
            <div class="form-label-inline">Durasi</div>
            <input type="text" name="durasi" data-type="number" class="form-input input-durasi" maxlength="3" /> Hari
        </div>
        ...
        <div class="btn btn-insert-tour-group">Insert Tour Package</div>
    </form>
</div>
<div class="section section-update">
    ...
    <div class="tour-group-container">
        <?php
        $iLength = sizeof($tour_package);
        for ($i = 0; $i < $iLength; $i++) {
            echo "<div class='tour-group-item' data-id='" . $tour_package[$i]->tg_kode . "'>";
            echo "<div class='tour-group-item-image' style='background-image: url(" . base_url("assets/images/tour_groups/tour_groups_" . $tour_package[$i]->tg_kode) . "." . $tour_package[$i]->tg_image_extension . "?d=" . strtotime($tour_package[$i]->modified_date) . ");'></div>";
            echo "<div class='tour-group-item-nama'>" . $tour_package[$i]->tg_nama . "</div>";
            echo "<div class='tour-group-item-rute'>" . $tour_package[$i]->tg_rute . "</div>";
            echo "<div class='tour-group-item-durasi'>" . $tour_package[$i]->tg_durasi . " hari</div>";
            echo "<a class='btn btn-edit-tour-group-item' href='" . base_url("admin/tour_package_detail/" . $tour_package[$i]->tg_kode) . "'>Edit Tour Package</a>";
            echo "<form class='form-delete-tour-package' method='post' action='" . base_url("admin/tour_package_delete") . "'>";
            echo "<input type='hidden' name='tg_kode' value='" . $tour_package[$i]->tg_kode . "' />";
            echo "<div class='btn btn-negative btn-delete-tour-package'>Delete</div>";
            echo "</form>";
            echo "</div>";
        }
        ?>
...
<div class="dialog dialog-add-itinerary" data-type="add" data-source="insert">
    <div class="dialog-background">
        <div class="dialog-box">
            ...
            <div class="dialog-text">
                <div class="form-item">
                    <div class="form-label-inline">Hari ke </div>
                    <input type="text" data-type="number" value="1" class="form-input input-add-itinerary-day" />
                </div>
                <div class="form-item">
                    <div class="form-label-inline">Tempat</div>
