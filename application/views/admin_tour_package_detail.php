...
?>
<div class="section">
    <form class="form-update" enctype="multipart/form-data" method="post" action="<?php echo base_url("admin/tour_package_update"); ?>">
        ...
        <div class="form-item">
            ...
            <input type="text" name="tour_group_description" class="form-input input-description" maxlength="225" value="<?php echo $data->tg_description; ?>" />
        </div>
        <div class="tanggal-container">
            <input type="hidden" name="tanggal_count" value="<?php echo sizeof($date); ?>" />
            <?php
            $iLength = sizeof($date);
            for ($i = 0; $i < $iLength; $i++) {
                echo "<div class='tanggal-inner-container'>";
                echo "<div class='form-item-inline'>";
                echo "<div class='form-label-inline'>Mulai Tanggal</div>";
                echo "<input type='text' name='date_start_" . ($i + 1) . "' class='form-input input-date-start' maxlength='10' data-type='date' value='" . $date[$i]->tg_tglStart . "' />";
                echo "</div>";
                echo "<div class='form-item-inline'>";
                echo "<div class='form-label-inline'>Sampai Tanggal</div>";
                echo "<input type='text' name='date_end_" . ($i + 1) . "' class='form-input input-date-end'  maxlength='10' data-type='date' value='" . $date[$i]->tg_tglEnd . "' />";
                echo "</div>";
                if ($i > 0) {
                    echo "<div class='btn btn-negative btn-delete-tanggal'>Delete</div>";
                }
                echo "</div>";
            }
            ?>
        ...
        <div class="form-item">
            ...
            <input type="text" name="durasi" data-type="number" class="form-input input-durasi" maxlength="3" value="<?php echo $data->tg_durasi; ?>" /> Hari
        </div>
        ...
        <div class="form-right">
            <div class="itinerary-container">
                ...
                for ($i = 0; $i < $iLength; $i++) {
                    ...
                    echo "<div class='itinerary-item-text'>Hari ke " . $itinerary[$i]->tgi_hari . "</div>";
                    ...
                    echo "<input type='hidden' name='source' value='tour_package' />";
        ...
        <div class="dialog-box">
            ...
            <div class="dialog-text">
                <form class="form-insert-itinerary" method="post" action="<?php echo base_url("admin/itinerary_insert"); ?>">
                    <input type="hidden" name="source" value="tour_package" />
                    <input type="hidden" name="tg_kode" value="<?php echo $data->tg_kode; ?>" />
                    <input type="hidden" name="tgi_kode" value="" />
                    <div class="form-item">
                        <div class="form-label-inline">Hari ke </div>
                        <input type="text" name='itinerary_day' class="form-input input-add-itinerary-date" maxlength="3" data-type="number" />
                    </div>
                    <div class="form-item">
